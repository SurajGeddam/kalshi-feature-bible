...
**Screenshots:**  
- 014: `014-onboarding-legal-terms-modal.png` - Legal terms popup showing all agreements and policies accessible from sign-up/login
...
**Screenshots:**  
- 018: `018-onboarding-apple-oauth.png` - Apple ID authentication page for first-time OAuth authorization
